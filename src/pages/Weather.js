        ...
        <Menu />
        {
          !data.current_weather
            ? <main className="flex flex-row items-center justify-center p-2 w-screen h-screen">
              <svg aria-hidden="true" className="animate-spin h-12 w-12 mr-4 text-Gray75 fill-indigo-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            : <main className="grid grid-cols-1 grid-rows-[auto] sm:grid-cols-3 md:grid-cols-4 sm:grid-rows-4 md:grid-rows-3 p-2 mt-32">
              <Forecast data={ data } />
              <Chart data={ data } />
